document.addEventListener("DOMContentLoaded", function() {
    const stateSelect = document.getElementById("driver_state");
    const districtSelect = document.getElementById("driver_district");
    const subDivisionSelect = document.getElementById("driver_subdivision");
